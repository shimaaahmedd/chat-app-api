...
ActiveRecord::Schema.define(version: 2022_05_29_201713) do
  ...
  create_table "chats_users", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "chat_id"
    t.bigint "user_id"
